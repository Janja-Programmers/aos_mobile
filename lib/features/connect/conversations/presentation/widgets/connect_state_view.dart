...
import 'package:africaonlinestores/features/connect/conversations/presentation/widgets/connect_list_shimmer.dart';
...
class ConnectStateView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (type == ConnectStateType.loading) {
      return ConnectListShimmer(semanticsLabel: '$title. $message');
    }
        ...
        child: ConstrainedBox(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                _StateIcon(icon: icon, accentColor: accentColor),
...
class _StateIcon extends StatelessWidget {
  ...
  const _StateIcon({required this.icon, required this.accentColor});
