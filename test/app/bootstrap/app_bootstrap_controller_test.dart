...
void main() {
  test('process restoration loads the persisted onboarding state once', () async {
  ...
  test('missing persisted onboarding state resolves to ready and incomplete', () async {
    SharedPreferences.setMockInitialValues(<String, Object>{});
    final SharedPreferences preferences =
        await SharedPreferences.getInstance();
    final AppBootstrapController controller = AppBootstrapController(
    ...
    expect(
      ...
      isA<AppBootstrapState>()
          .having((AppBootstrapState state) => state.isReady, 'isReady', isTrue)
          .having(
